package io.example.asyncapi.provider.clinicaltool.modules.surveys.config
...
open class ServicesInMemoryConfig : RepositoriesInMemoryConfig() {
	...
	fun reloadTestData() {
		...
		val testDataLoader = TestDataLoader(listOf(Survey::class.java, SurveySection::class.java, SectionTranslation::class.java, Question::class.java, QuestionTranslation::class.java, Option::class.java, OptionTranslation::class.java, SurveyAnswers::class.java, Answer::class.java))
