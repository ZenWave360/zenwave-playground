...
data class TermsAndConditions(
    ...
    @NotNull @Column(name = "content", nullable = false) @Lob var content: String? = null,

    /** language code */
    @NotNull @Size(max = 3) @Column(name = "lang", nullable = false, length = 3) var lang: String? = null,

    /** Arbitrary version string */
    @NotNull @Column(name = "content_version", nullable = false, unique = true) var contentVersion: String? = null,

    /** Date when the terms and conditions are valid (inclusive) */
    @NotNull @Column(name = "start_date", nullable = false, unique = true) var startDate: LocalDate? = null,
) : Serializable {
