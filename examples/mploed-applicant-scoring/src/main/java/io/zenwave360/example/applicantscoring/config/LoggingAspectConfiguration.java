...
public class LoggingAspectConfiguration {
    ...
    public static class LoggingAspect {
         ...
         */
        @Pointcut("within(io.zenwave360.example.applicantscoring.core.implementation..*)"
                + " || within(io.zenwave360.example.applicantscoring.infrastructure..*)" + " || within(io.zenwave360.example.applicantscoring.adapters..*)")
