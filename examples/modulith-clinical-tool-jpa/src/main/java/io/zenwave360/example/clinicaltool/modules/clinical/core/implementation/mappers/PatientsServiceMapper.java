...
// input mappings
    ...
    @Mapping(target = "id", ignore = true)Patient update(@MappingTarget Patient entity, java.util.Map input);
    // Patient-Patient updatePatient
        Patient asPatient(Patient input);
    @Mapping(target = "id", ignore = true)Patient update(@MappingTarget Patient entity, Patient input);
// output mappings
