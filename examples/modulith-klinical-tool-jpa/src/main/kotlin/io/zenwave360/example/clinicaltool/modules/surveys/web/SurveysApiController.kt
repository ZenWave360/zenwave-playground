...
open class SurveysApiController(
    ...
    override fun updateSurveyAnswers(surveyId: Long, patientId: Long, date: LocalDate, input: PatchMap): ResponseEntity<SurveyAnswersDTO> {
