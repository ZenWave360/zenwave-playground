package io.example.asyncapi.provider.clinicaltool.modules.termsandconditions.config
...
open class ServicesInMemoryConfig : RepositoriesInMemoryConfig() {
    ...
    protected val termsAndConditionsService = TermsAndConditionsServiceImpl(acceptedTermsAndConditionsRepository(), termsAndConditionsRepository()
        )
    @Bean
	...
	fun reloadTestData() {
		...
		val testDataLoader = TestDataLoader(listOf(AcceptedTermsAndConditions::class.java, TermsAndConditions::class.java))
		val acceptedTermsAndConditions = _acceptedTermsAndConditions ?: testDataLoader.loadCollectionTestDataAsObjects(AcceptedTermsAndConditions::class.java)
		acceptedTermsAndConditionsRepository().deleteAll()
		acceptedTermsAndConditionsRepository().saveAll(acceptedTermsAndConditions)
		val termsAndConditions = _termsAndConditions ?: testDataLoader.loadCollectionTestDataAsObjects(TermsAndConditions::class.java)
