...
public interface SurveysServiceMapper {
    ...
    SurveyAnswers update(@MappingTarget SurveyAnswers entity, String name, Long patientId, String lang);
    // SurveyAnswers-SurveyAnswers answerSurvey
    SurveyAnswers asSurveyAnswers(SurveyAnswers input);

    @Mapping(target = "id", ignore = true)
    SurveyAnswers update(@MappingTarget SurveyAnswers entity, SurveyAnswers input);
    // java.util.Map-SurveyAnswers updateSurveyAnswers
    SurveyAnswers asSurveyAnswers(java.util.Map input);

    @Mapping(target = "id", ignore = true)
    SurveyAnswers update(@MappingTarget SurveyAnswers entity, java.util.Map input);
    // output mappings
