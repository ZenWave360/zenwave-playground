...
// input mappings
    ...
    @Mapping(target = "id", ignore = true)User update(@MappingTarget User entity, SearchCriteria input);
    // User-User updateUser
        User asUser(User input);
    @Mapping(target = "id", ignore = true)User update(@MappingTarget User entity, User input);
// output mappings
}
