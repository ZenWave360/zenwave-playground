...
interface EventsMapper {
    ...
    fun asPatientCreated(
        patient: Patient
    ): io.zenwave360.example.clinicaltool.modules.clinical.core.domain.events.PatientCreated

    fun asDoctorCreated(
        input: Doctor
    ): io.zenwave360.example.clinicaltool.modules.clinical.core.domain.events.DoctorCreated
}
