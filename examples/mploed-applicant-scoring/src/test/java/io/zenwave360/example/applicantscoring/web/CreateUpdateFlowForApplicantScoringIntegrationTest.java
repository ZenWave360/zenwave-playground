...
public class CreateUpdateFlowForApplicantScoringIntegrationTest extends BaseWebTestClientTest {
    ...
    public void testCreateUpdateFlowForApplicantScoringIntegrationTest() {
        ...
        var createApplicantScoringResponse1 = webTestClient
                .method(POST)
        ...
        var updateCityResponse2 = webTestClient
                .method(POST)
        ...
        var updateBalanceAtBankResponse3 = webTestClient
                .method(POST)
        ...
        var getApplicationScoringResponse0 = webTestClient
                .method(GET)
