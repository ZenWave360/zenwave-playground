...
// input mappings
    ...
    @Mapping(target = "id", ignore = true)Survey update(@MappingTarget Survey entity, Survey input);
    // Question-Question updateQuestion
        Question asQuestion(Question input);
    @Mapping(target = "id", ignore = true)Question update(@MappingTarget Question entity, Question input);
// output mappings
}
