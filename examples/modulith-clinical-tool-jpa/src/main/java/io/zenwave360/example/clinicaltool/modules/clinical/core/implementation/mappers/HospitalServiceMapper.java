...
// input mappings
    ...
    @Mapping(target = "id", ignore = true)Doctor update(@MappingTarget Doctor entity, Doctor input);
    // HospitalIdnull-Doctor listHospitalDoctors
        Doctor asDoctor(Long hospitalId);
    @Mapping(target = "id", ignore = true)Doctor update(@MappingTarget Doctor entity, Long hospitalId);
    // Hospital-Hospital updateHospital
        Hospital asHospital(Hospital input);
    @Mapping(target = "id", ignore = true)Hospital update(@MappingTarget Hospital entity, Hospital input);
    // HospitalIdnull-Hospital listHospitalPatients
        Hospital asHospital(Long hospitalId);
    @Mapping(target = "id", ignore = true)Hospital update(@MappingTarget Hospital entity, Long hospitalId);
// output mappings
