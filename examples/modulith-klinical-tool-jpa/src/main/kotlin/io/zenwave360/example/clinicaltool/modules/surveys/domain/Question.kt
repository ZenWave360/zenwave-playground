...
data class Question(
    ...
    @Column(name = "required") var required: Boolean? = true,
    @Column(name = "range_start") var rangeStart: Integer? = null,
    @Column(name = "range_end") var rangeEnd: Integer? = null,
    ...
    @Column(name = "include_other") var includeOther: Boolean? = false,
) : Serializable {
