...
@Suppress("unused")
@Repository
interface AcceptedTermsAndConditionsRepository : JpaRepository<AcceptedTermsAndConditions, Long> {fun findByUserId(userId: Long): java.util.Optional<AcceptedTermsAndConditions>
}
