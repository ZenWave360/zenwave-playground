package io.zenwave360.example.clinicaltool.modules.users.core.implementation;
...
import io.zenwave360.example.clinicaltool.modules.users.core.implementation.mappers.*;
...
public class UserServiceImpl implements UserService {
    ...
    public Optional<User> updateUser(String username, User input)
 {
    ...
    var user = userRepository.findByUsername(username).map(existingUser -> {
