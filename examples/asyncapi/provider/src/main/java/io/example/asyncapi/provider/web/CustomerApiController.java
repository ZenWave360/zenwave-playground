package io.example.asyncapi.provider.web;
...
import io.example.asyncapi.provider.web.mappers.*;
...
public class CustomerApiController implements CustomerApi {
    ...
    @Override
    public ResponseEntity<CustomerPaginatedDTO> listCustomers(Integer page, Integer limit, List<String> sort) {
        log.debug("REST request to listCustomers: {}, {}, {}", page, limit, sort);
