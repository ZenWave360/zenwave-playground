...
public class ServicesInMemoryConfig extends RepositoriesInMemoryConfig {
    ...
    protected final SurveysBackofficeServiceImpl surveysBackofficeService =
            new SurveysBackofficeServiceImpl(surveyRepository(), questionRepository());
    ...
    public void reloadTestData() {
        ...
        var questions =
                _questions != null ? _questions : testDataLoader.loadCollectionTestDataAsObjects(Question.class);
        questionRepository().deleteAll();
        questionRepository().saveAll(questions);
        var surveyAnswers = _surveyAnswers != null
                ? _surveyAnswers
                : testDataLoader.loadCollectionTestDataAsObjects(SurveyAnswers.class);
