package io.example.asyncapi.provider.clinicaltool.modules.users.domain
...
data class User(
    ...
    @NotNull@Column(name = "username", nullable = false, unique = true) @org.hibernate.annotations.NaturalId
    ...
    @NotNull@Column(name = "roles", nullable = false)
