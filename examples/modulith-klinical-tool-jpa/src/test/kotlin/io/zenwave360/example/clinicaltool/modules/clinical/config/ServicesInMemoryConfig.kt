...
open class ServicesInMemoryConfig : RepositoriesInMemoryConfig() {
    ...
    protected val patientsService = PatientsServiceImpl(patientRepository(), eventPublisher)
        ...
        val testDataLoader =
            TestDataLoader(
                listOf(
                    ...
                    HealthInsuranceInfo::class.java,
                    PatientAddress::class.java,
                    HospitalAddress::class.java,
                    PatientWearable::class.java,
                    MedicalContact::class.java,
                    PersonalContact::class.java,
                )
            )
