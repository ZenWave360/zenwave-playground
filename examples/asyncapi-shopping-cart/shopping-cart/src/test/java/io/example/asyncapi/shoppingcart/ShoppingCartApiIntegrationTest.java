...
public class ShoppingCartApiIntegrationTest extends BaseWebTestClientTest {
    ...
    public void testLoadShoppingCart_200() {
        ...
        webTestClient
                .method(GET)
                .uri("/api/shopping-cart/{customerId}", customerId)
    ...
    public void testAddItem_201() {
        ...
        webTestClient
                .method(POST)
                .uri("/api/shopping-cart/{customerId}/items", customerId)
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testRemoveItem_204() {
        ...
        webTestClient
                .method(DELETE)
                .uri("/api/shopping-cart/{customerId}/items/{name}", customerId, name)
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
                .expectStatus()
                .isEqualTo(204)
