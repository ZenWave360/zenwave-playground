...
@AnalyzeClasses(packages = "io.zenwave360.example.clinicaltool", importOptions = DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule respectsLayersForHexagonalArchitecture = layeredArchitecture()
        .consideringOnlyDependenciesInAnyPackage("io.zenwave360.example.clinicaltool..")
        .layer("Any").definedBy("..")
